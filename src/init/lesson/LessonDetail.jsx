...
const LessonDetail = ({ lessonSeq }) => {
    const curriculumSeq = Math.ceil(lessonSeq / 2);
    const lesson = DUMMY_LESSON_LIST[curriculumSeq - 1]?.find(item => item.seq === parseInt(lessonSeq));
